...
#define ILI9341_INTERFACE_WIDTH_16                // 16 bit vodilo
//#define ILI9341_INTERFACE_WIDTH_8               	// 8 bit vodilo

// Potrebno je specificirati resolucijo LCD zaslona v pokončni "portretni" orientaciji zaslona.
