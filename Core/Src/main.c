...
int main(void)
{
  ...
  /* LCD_BKLT_set_brightness(60);  osciloskop test */
 // GFX_demo();
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  //		DEMONSTRACIJA UPORABE STANJA Z NIZKO PORABO


	    // Če želimo resni�?no zagotoviti "nemoteno spanje mikrokrmilnika" in �?e ne potrebujemo
	    	// števca milisekund SysTick, potem lahko onemogo�?imo prekinitve ob "tiktakanju"
	    	// SysTick števca s klicem funkcije HAL_SuspendTick().
	    	// Poskusite spodnjo vrsto zakomentirati oz. odkomentirati.
	    	//HAL_SuspendTick();
	    	  //
	    	// Glavna neskon�?na zanka v "main.c".
